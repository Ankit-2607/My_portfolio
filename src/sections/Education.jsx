  ...
  return (
    ...
    >
      ...
      <div ref={trackRef} className="relative max-w-6xl mx-auto px-6">
        ...
        <div
          ref={fillRef}
          className="absolute left-1/2 top-0 w-0.5 -translate-x-1/2 bg-linear-to-b from-purple-400 via-fuchsia-400 to-amber-400 shadow-[0_0_12px_rgba(217,70,239,0.8)]"
          style={{ height: "0%" }}
        />
            ...
            return (
              ...
              >
                ...
                <div className="w-full md:w-1/2 flex justify-center">
                  <div
                    className="group relative w-[92%] md:w-[85%] rounded-2xl bg-white/6 backdrop-blur-md border border-white/10 p-6 md:p-7 transition-all duration-500 hover:-translate-y-1.5 hover:bg-white/9"
